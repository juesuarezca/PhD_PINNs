...
folder = 'Results_Simulation/27.04/'
...
plt.legend()
plt.savefig(folder + 'Loss_Quad_'+str(e_l)+'_'+str(DEG)+'_n_epoch_'+str(n_epoch)+'.png')
...
pinn_1.load_model('/home/suarez08/PhD_PINNs/'+folder+'best_model_Mse.pt')
PRED_1 = pinn_1(X_c.float())
pinn_2.load_model('/home/suarez08/PhD_PINNs/'+folder+'best_model_Quad.pt')
PRED_2 = pinn_2(X_c.float())
pinn_3.load_model('/home/suarez08/PhD_PINNs/'+folder+'best_model_Mse.pt')
